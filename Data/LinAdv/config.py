...
def cla():
    ...
    parser.add_argument('--Nu', type=int, default=10000, help=textwrap.dedent('''Number of realizations of the solution (default: %(default)s). '''))
    ...
    parser.add_argument('--vel',type=float,default=1.0, help=textwrap.dedent('''Velocity (default: %(default)s). ''')) 
